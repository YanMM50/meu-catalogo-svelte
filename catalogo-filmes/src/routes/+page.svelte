<script>
  ...
  const filmes = [
    ...
    { id: 11, titulo: 'Brilho Eterno de uma Mente sem Lembranças', genero: 'Ficção Científica', ano: 2004, nota: 8.3, emoji: '🧠', sinopse: 'Um casal apaga memórias um do outro; um tenta salvar as lembranças apagadas.' },
    { id: 12, titulo: 'Efeito Borboleta', genero: 'Ficção Científica', ano: 2004, nota: 7.7, emoji: '🦋', sinopse: 'Pequenas mudanças nas escolhas do passado transformam vidas em realidades imprevisíveis.' },
    { id: 13, titulo: 'Contra o Tempo', genero: 'Ficção Científica', ano: 2011, nota: 7.5, emoji: '⏳', sinopse: 'Um soldado revive os mesmos minutos para impedir um ataque e descobrir sua própria verdade.'}
  ]
